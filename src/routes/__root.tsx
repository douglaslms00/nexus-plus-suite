...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0E1D40" },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f56deb1b-9e21-4a1e-85be-e5cc855f7e79/id-preview-959f7836--6e37b413-08a0-4e4a-986e-292ccd010856.lovable.app-1780436427244.png",
      },
