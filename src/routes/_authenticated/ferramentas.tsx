        ...
        <TabsContent value="emp" className="space-y-3">
                ...
                >
                  <div className="space-y-1">
                    ...
                    >
                      ...
                      <SelectContent>
                        {ferramentas
                          .filter((f: any) => f.estado === "disponivel")
                          .map((f: any) => (
          ...
          <div className="grid gap-2">
              ...
              <Card key={e.id} className="p-3 flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium">
                    {e.ferramenta?.nome} → {e.funcionario?.nome ?? "—"}
                  </p>
                  <p className="text-xs text-muted-foreground">
                    Empréstimo: {e.data_emprestimo}{" "}
                    {e.prevista_devolucao && `· prev: ${e.prevista_devolucao}`}{" "}
            ...
            {emprestimos.length === 0 && (
              <Card className="p-8 text-center text-muted-foreground">Nenhum empréstimo.</Card>
            )}
          </div>
        </TabsContent>
      </Tabs>
